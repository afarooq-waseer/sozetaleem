...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getQuery as getQuery$1, readBody, getRouterParam, setHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/nitropack/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/vue/index.mjs';
import { basename, isAbsolute } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/afarooq/Documents/Projects/sozetaleem/frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/afarooq/Documents/Projects/sozetaleem/frontend","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/afarooq/Documents/Projects/sozetaleem/frontend/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/afarooq/Documents/Projects/sozetaleem/frontend/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/afarooq/Documents/Projects/sozetaleem/frontend/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/afarooq/Documents/Projects/sozetaleem/frontend/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/afarooq/Documents/Projects/sozetaleem/frontend/public"
      ]
    },
    "http": {
      "domains": []
...
const _fpfjcWDJXgxjszVUKeYGrchVEJRnxnB6psRchEU_vo = (function(nitro) {
...
const _NmKEbUtHhL7CTnRiw5rpxHhFULoW9uZ20huYONUyPg = (nitroApp) => {
...
const _sJXgj3XWTjNuhCnHLgH3CybE1IC8jHejLUgmwJvego = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _fpfjcWDJXgxjszVUKeYGrchVEJRnxnB6psRchEU_vo,
_NmKEbUtHhL7CTnRiw5rpxHhFULoW9uZ20huYONUyPg,
_sJXgj3XWTjNuhCnHLgH3CybE1IC8jHejLUgmwJvego
];
...
const _TDpV0m = defineCachedEventHandler(async (event) => {
...
const getServerEntry = () => import('file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _dcR6Yz = eventHandler(async (event) => {
  ...
  return await import('file:///Users/afarooq/Documents/Projects/sozetaleem/frontend/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _FWCv5P = eventHandler(async (event) => {
...
const _hzPVDA = lazyEventHandler(() => {
...
const _lazy_DaTHkT = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_DaTHkT, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _TDpV0m, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _dcR6Yz, lazy: false, middleware: false, method: undefined },
